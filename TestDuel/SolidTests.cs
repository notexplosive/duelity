...
namespace TestDuel
{
    public class SolidTests
    {
        ...
        public void empty_space_is_not_solid_if_in_bounds()
        {
            ...
            solidProvider.IsNotWalkableAt(new Point(0, 0)).Should().BeFalse();
        }
        ...
        public void empty_space_is_solid_if_out_of_bounds()
        {
            ...
            solidProvider.IsNotWalkableAt(new Point(10, 10)).Should().BeTrue();
        }
        ...
        public void solid_entities_are_solid()
        {
            ...
            solidProvider.IsNotWalkableAt(new Point(1, 1)).Should().BeTrue();
        }
